    ...
    while True:
        with lock:
            ...
            if latest_rotation:
                ...
                xW = 1.5 if joystick_state[0] > 0.3 else -1.5 if joystick_state[0] < -0.3 else 0.0
                yW = -0.8 if joystick_state[1] > 0.3 else 0.8 if joystick_state[1] < -0.3 else 0.0
                turnR = 1.5 if joystick_state[4] > 0.3 else 0.0
                turnL = 1.5 if joystick_state[5] > 0.3 else 0.0
